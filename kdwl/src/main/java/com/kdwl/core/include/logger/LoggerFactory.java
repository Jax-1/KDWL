package com.kdwl.core.include.logger;
...
public final class LoggerFactory {
    ...
    private static void fixSubstituteLoggers() {
        SubstituteLoggerFactory var0 = SUBST_FACTORY;
    ...
    static Set<URL> findPossibleStaticLoggerBinderPathSet() {
        ...
        try {
            ClassLoader loggerFactoryClassLoader = org.slf4j.LoggerFactory.class.getClassLoader();
            Enumeration paths;
    ...
    public static ILoggerFactory getILoggerFactory() {
        if (INITIALIZATION_STATE == 0) {
            Class var0 = org.slf4j.LoggerFactory.class;
