...
<head>
  ...
  <link href="<%=basePath%>css/site.css" type="text/css" rel="stylesheet"></link>
  <title>后台管理 -- 新增运单</title>
  <style type="text/css"></style>
	...
	<script type="text/javascript">
		$().ready(function() {
			...
			jQuery.extend(jQuery.validator.messages, {remote: "单号已存在，请重新输入."});

			//表单验证
			$("#shipment_from_id").validate({
				rules: {
					'shipment.kdno': {required:true, maxlength:100,remote:"<%=basePath%>kdnoValidate"},
...
<div id="wrapper">
	<div id="container">
  	...
  	<form name="shipment_from" id="shipment_from_id" action="<%=basePath%>newShipment" method="post">
		<div id="chartarea">
