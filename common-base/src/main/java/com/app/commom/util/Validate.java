...
public class Validate {
    ...
    public static Boolean notNull(Object value) {
        Boolean temp = null == value ? false : true;
        return temp;
    }
...
//    //判断整型
     ...
     * @return
     */
    public static ProcessResult checkIDCard(String idCard) {
